 ...
 * @Discription
 * @Author guoxiaojing
 * @CreateDate 2018/2/28 11:37
 * @Version 1.0
 */
public class AsserAction extends TestBaseCase{
    //收集断言异常用于报表日志展示
    ...
    private static Logger log=Logger.getLogger(AsserAction.class);
    ...
    private static void snapshotInfo()
    {
        ...
        screenShot.setscreenName(AsserAction.formatDate(nowDate));
        screenShot.takeScreenshot();
        //AsserAction.assertInfolList.add("&lt;a href=\"snapshot/"+AsserAction.formatDate(nowDate)+".jpg\" &gt;&lt;img height=\"100\" width=\"100\" src=\"snapshot\\"+AsserAction.formatDate(nowDate)+".jpg\"&gt;&lt;/img&gt;&lt;/a&gt;&lt;br/&gt;"+"&lt;a href=\"snapshot\\"+AsserAction.formatDate(nowDate)+".jpg\" &gt;点击查看大图&lt;/a&gt;\n");
        AsserAction.messageList.add("&lt;a class=\"clickbox\" href=\"#url\"&gt;\n"
                + "&lt;img src=\"snapshot/"
                + AsserAction.formatDate(nowDate)
    ...
    public static  void VerityTextPresent(String exceptStr)
    {
        ...
        try {
            ...
            webdriver.findElements(By.xpath(exceptStr));
            if (webdriver.findElements(By.xpath(exceptStr)).size()>0) {
                flag=true;
            }
            else {
                flag=false;
    ...
    public static  void VerityTextPresent(String exceptStr,String Message)
    {
        ...
        try {
            ...
            List<WebElement> webElements= webdriver.findElements(By.xpath(exceptStr));
    ...
    public static  void VerityNotTextPresent(String exceptStr)
    {
        ...
        try {
            ...
            webdriver.findElement(By.xpath(exceptStr));
            flag=false;
        } catch (NoSuchElementException e) {
            // TODO: handle exception
            flag=true;
    ...
    public static  void VerityTextPresentPrecision(String exceptStr,String Message)
    {
        ...
        try {
            exceptStr="//*[text()=\""+exceptStr+"\"]";
            WebElement webElement=webdriver.findElement(By.xpath(exceptStr));
            System.out.println(exceptStr);
            flag=true;
        } catch (NoSuchElementException e) {
            // TODO: handle exception
    ...
    public static void main(String[] args) {
        ...
        AsserAction.VerityCationString("刘兰39", "刘兰");
        AsserAction.VerityCationString("刘兰39", "刘兰", "验证是否按医生姓名查询出结果");
    }
}
